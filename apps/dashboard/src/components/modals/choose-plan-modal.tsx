    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-[696px]">
        <div className="p-8">
          ...
          <DialogDescription className="mb-8">{getDescription()}</DialogDescription>

          <Plans />

          <p className="text-muted-foreground mt-4 text-xs">
            After the trial period ends, you'll have read-only access, <Link href="/support">contact us</Link> if you
            have any questions.
          </p>
        </div>
      </DialogContent>
