  ...
  return (
    <Link prefetch href={child.path} onClick={() => onSelect?.()} className="group/child block">
      <div className="relative">
        ...
        <div
          className={cn(
            "ml-[35px] mr-[15px] flex h-[32px] items-center",
            "border-l pl-3",
    ...
    <div className="group">
      <Link prefetch href={item.path} onClick={() => onSelect?.()} className="group">
        <div className="relative">
          ...
          <div
            className={cn(
              "ease-&lsqb;cubic-bezier(0.4,0,0.2,1)&rsqb; ml-[15px] mr-[15px] h-[40px] border border-transparent transition-all duration-200",
          ...
          <div className="group-hover:!text-primary pointer-events-none absolute left-[15px] top-0 flex h-[40px] w-[40px] items-center justify-center text-black dark:text-[#666666]">
          ...
          {isExpanded && (
            <div className="pointer-events-none absolute left-[55px] right-[4px] top-0 flex h-[40px] items-center">
              <span
                className={cn(
              ...
              {hasChildren && (
                <button
                  ...
                  className={cn(
                    "ml-auto mr-3 flex h-8 w-8 items-center justify-center transition-all duration-200",
