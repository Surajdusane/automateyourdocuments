...
export function Sidebar() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-background border-border ease-&lsqb;cubic-bezier(0.4,0,0.2,1)&rsqb; absolute left-0 top-0 flex h-[70px] items-center justify-center border-b transition-all duration-200",
